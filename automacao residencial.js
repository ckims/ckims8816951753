...
function lampada(){
    ...
    if(lamp === "0"){
        document.getElementById("lamp").innerHTML="1";
        document.getElementById("led").innerHTML="<div class='wrapper2'></div>";
    } else {
        document.getElementById("lamp").innerHTML="0";
        document.getElementById("led").innerHTML="<div class='wrapper3'></div>";
   }
}